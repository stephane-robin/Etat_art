...
Plusieurs niveaux de tests ont dû être effectués pour valider le package avant publication.
\begin{itemize}
\item l'environnement de développement nous a servi pour effectuer les tests unitaires, les tests d'intégration, les tests de performance et les tests de non-régression,
\item l'environnement d'évaluation nous a servi pour effectuer les tests fonctionnels, les tests CLI, les tests de configuration et les tests d'installation
\end{itemize}
...
Les tests unitaires consistent à évaluer individuellement les composants de l'application (parties de code autonomes, fonctions), en terme de qualité et validation des résultats attendus. Nous réalisons les tests unitaire dans l'environnement de développement dans lequel nous avons construit notre application.
