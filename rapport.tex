...
Il est donc possible de télécharger un package provenant d'index différents de PyPI. Par exemple, l'installation de CRISPRbuilder\_TB à partir de testPyPI se fait à l'aide de l'instruction suivante, après s'être assuré qu'on utilise bien une version 3 de Python
...
Ce type de tests permet de s'assurer que l'utilisateur sera en mesure d'installer le package quel que soit le système d'exploitation utilisé. Il nécessite l'utilisation d'une machine virtuelle... VIRTUALBOX
