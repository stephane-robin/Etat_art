...
Notons que par mesure de sécurité, on ne peut pas supprimer une version du package en vue de la modifier. On peut uniquement créer une nouvelle version et la publier, ou encore supprimer le package. Dans ce cas, il n'est plus possible de créer un package du même nom. On peut simplement créer une nouvelle version
