...
\begin{verbatim}  $ cd crisprbuilder_tb 
  ...
  $ poetry add openpyxl 
  $ poetry add xlrd 
  $ poetry add biopython\end{verbatim}
...
\begin{verbatim}  [tool.poetry.dependencies]
  xlrd = "1.2.0"
  xmltodict = "0.12.0"
  biopython = "1.76"\end{verbatim}

TODO - MANQUE OPENPYXL ET PYTHON
...
\begin{verbatim}\texttt{\$ python -m crisprbuilder\_tb \textemdash \textemdash help}\end{verbatim}

fournit bien les informations relatives aux options du package, à savoir
A COMPLETER ???

\begin{verbatim}  $ python -m crisprbuilder_tb --change 0\end{verbatim}

\begin{verbatim}  $ python -m crisprbuilder_tb --remove 0\end{verbatim}

\begin{verbatim}  $ python -m crisprbuilder_tb --add 0\end{verbatim}
