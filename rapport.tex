...
Note préalable : toutes les explications données dans ce chapitre concernent les plateformes Linux et sont transposables en une moindre mesure sur MacOS, mais pas nécessairement sur Windows.
...
Windows platforms, the installation requires the same instruction. From your current directory, first install the dependencies then the package by writing in the command prompt:

    \begin{verbatim}
  $ pip install xlrd==1.2.0
  $ pip install xmltodict==0.12.0
  $ pip install biopython==1.76
  $ pip install parallel-fastq-dump==0.6.5
...
on your computer might be different. You can also check that \textit{pip} is linked to Python3 by writing \texttt{pip --version}, which will display a line similar to
