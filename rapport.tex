...
Notons que le fichier README.md reste en dehors du répertoire \textbf{crisprbuilder\_tb}, car à cet emplacement il peut être lu par PyPI, et constitue le contenu de la rubrique "Package description" sur le site \href{https://www.pypi.org}{https://www.pypi.org}. 
...
C'est le fichier README.md qui est utilisé pour la description du projet par PyPI sur le site ou encore testPyPI sur le site

 \href{https://www.test.pypi.org/project/crisprbuilder\_tb}{https://www.test.pypi.org/project/crisprbuilder\_tb}
...
\begin{verbatim}  $ pip3 install -i https://test.pypi.org/simple/ crisprbuilder_tb}\end{verbatim} 

ou si on précise la version du package

\begin{verbatim}  $ pip3 install -i https://test.pypi.org/simple/ crisprbuilder_tb==0.1.2\end{verbatim} A noter qu'il ne faut utiliser de guillemets autour de la version du package.
...
\begin{verbatim}  $ python3 -m pip install nom_package\end{verbatim}
